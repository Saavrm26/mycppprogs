...
// bool unboundedKnap(vi v,int i,ll mean,int M){
//     if(mean==x){
//         return 1;
//     }
//     if(m.find({mean,M})!=m.end()){
//         return m[{mean,M}];
//     }
//     if(i==0){
//         return 0;
//     }
//     bool f1=unboundedKnap(v,i-1,mean,M);
//     bool f2=unboundedKnap(v,i,(mean*M+v[i])/(M+1),M+1);
//     m[{mean,M}]=f1|f2;
//     return f1|f2;
