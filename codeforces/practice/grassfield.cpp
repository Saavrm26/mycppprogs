...
void solve(){
    ...
    cin>>(v[1][0]);
    cin>>(v[1][1]);
    if(v[0][0]==0&&v[0][1]==0&&v[1][0]==0&&v[1][1]==0)
        cout<<0<<'\n';
    else if(v[0][0]==1&&v[0][1]==1&&v[1][0]==1&&v[1][1]==1){
        cout<<2<<"\n";
    }
    else if((v[0][0]==1&&v[1][1]==0)||(v[0][0]==0&&v[1][1]==1)||(v[0][1]==1&&v[1][0]==0)||(v[0][1]==0&&v[1][0]==1)){
        cout<<1<<"\n";
    }
    else if((v[0][0]==1&&v[1][1]==1)||(v[0][1]==1&&v[1][0]==1))
        cout<<1<<"\n";
}