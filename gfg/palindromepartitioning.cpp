...
public:
    ...
    int palPart(string str,int i,int j){
        ...
        ff(k,l,r-1){
            int left,right;
            if(dp[l][k]!=-1) left=dp[i][k];
            else left=palPart(str,l,k);
            if(dp[k+1][r]!=-1) right=dp[k+1][r];
            else right=palPart(str,k+1,r);
    ...
    int palindromicPartition(string str)
    {
        ...
        return palPart(str,0,str.size()-1);
        // trace2d(dp,str.size()-1,str.size()-1);
        // return y;
    }
};
